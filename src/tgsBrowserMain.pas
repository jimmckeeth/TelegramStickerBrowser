...
type
  TForm12 = class(TForm)
    ...
    procedure SkAnimatedImage1AnimationDraw(ASender: TObject;
...
begin
  SkAnimatedImage1.Enabled := ckAnimate.IsChecked;
end;
...
procedure TForm12.SkAnimatedImage1AnimationDraw(ASender: TObject;
